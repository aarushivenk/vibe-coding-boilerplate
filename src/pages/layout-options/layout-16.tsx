...
const InterfaceBuilder = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50" style={{ fontFamily: 'Open Sans, sans-serif' }}>
            ...
            <div className="flex-1 flex items-start justify-center pt-8">
              <div className="max-w-md w-full p-8 space-y-4 rounded-lg shadow-sm bg-white">
                ...
                <div className="relative">
                  <div
                    className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-400 cursor-pointer"
                  ...
                  {selectedComponent === 'name-field' && (
                    <div className="absolute -top-2 -right-2 flex items-center gap-2 bg-white border rounded-lg shadow-lg px-3 py-2 z-10">
                      <span className="text-xs font-medium text-gray-700">Name Field</span>
                      <button
                ...
                <div className="relative">
                  ...
                  {selectedComponent === 'email-field' && (
                    <div className="absolute -top-2 -right-2 flex items-center gap-2 bg-white border rounded-lg shadow-lg px-3 py-2 z-10">
                      <span className="text-xs font-medium text-gray-700">Email Field</span>
                      <button
                        onClick={handleEditClick}
                        className="px-2 py-1 bg-blue-500 text-white text-xs rounded hover:bg-blue-600"
                      >
                ...
                <div className="relative">
                  ...
                  {selectedComponent === 'message-field' && (
                    <div className="absolute -top-2 -right-2 flex items-center gap-2 bg-white border rounded-lg shadow-lg px-3 py-2 z-10">
                      <span className="text-xs font-medium text-gray-700">Message Field</span>
                      <button
                        onClick={handleEditClick}
                        className="px-2 py-1 bg-blue-500 text-white text-xs rounded hover:bg-blue-600"
                      >
                ...
                <div className="relative">
                  ...
                  {selectedComponent === 'submit-button' && (
                    <div className="absolute -top-2 -right-2 flex items-center gap-2 bg-white border rounded-lg shadow-lg px-3 py-2 z-10">
                      <span className="text-xs font-medium text-gray-700">Submit Button</span>
                      <button
                        onClick={handleEditClick}
                        className="px-2 py-1 bg-blue-500 text-white text-xs rounded hover:bg-blue-600"
                      >
            ...
            <div className="flex-1 flex">
              {leftPaneOpen ? (
                ...
                <>
                  ...
                  <div className="flex-1 bg-white text-gray-800 font-mono text-sm p-4 overflow-auto border-l">
      ...
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-20 bg-white border border-gray-300 rounded-lg shadow-lg px-4 py-2">
        <div className="flex items-center gap-2">
          <button
            onClick={() => {
              setLeftPaneMode('copilot');
            ...
            className={`px-3 py-1 text-xs rounded ${
              leftPaneOpen && leftPaneMode === 'copilot' ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-100'
            }`}
          >
            AI
          </button>
          <button
            ...
            className={`px-3 py-1 text-xs rounded ${
              leftPaneOpen && leftPaneMode === 'design' ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-100'
            }`}
          >
            Design
          </button>
          <button
            ...
            className={`px-3 py-1 text-xs rounded ${
              !leftPaneOpen && viewMode === 'expression' ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-100'
            }`}
          >
            Expression
          </button>
